...
+ [[#invia][Sécurisation automatisée des boucles à la compilation]] /Julien Proy (INVIA)/
+ [[#cea-feliot][Techniques d'analyse statique pour détecter des vulnérabilités sécuritaires lors d'une revue de code]]
